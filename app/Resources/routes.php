...
$router->section('/docs/{fw_version}', array('fw_version' => '1.3.0'), function(Router $router, RouteCollection $routeCollection) use($routeNamespace) {

    /*$routeCollection->addOptions(array(
       'version' => '1.3.0'
    ));*/
