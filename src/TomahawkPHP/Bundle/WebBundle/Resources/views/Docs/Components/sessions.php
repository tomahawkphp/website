...
<?php $view['blocks']->start('content') ?>
    ...
    <p>
        The easiest way to use the Session component is to make sure your Controllers extend
        <code>Tomahawk\Routing\Controller</code>. You then have access to it through <code>$this->session</code>.
    </p>
