...
<?php $view['blocks']->start('content') ?>
    ...
    <div class="alert alert-info">
        In version 2.0 the namespace was changed from <code>Tomahawk\DI</code>
        to <code>Tomahawk\DependencyInjection</code>
    </div>
...
class WebBundle extends Bundle
{
    ...
    <p>
        To create a service provider you need to implement the <code>Tomahawk\DependencyInjection\ServiceProviderInterface</code> interface.
    </p>
...
use Tomahawk\HttpKernel\Bundle\Bundle;
use Tomahawk\DependencyInjection\ContainerInterface;
use MyCompany\Bundle\WebBundle\DependencyInjection\EmailServiceProvider;
