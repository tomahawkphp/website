...
<?php $view['blocks']->start('content') ?>
    ...
    <p>
        The easiest way to use the Hasher is to access to it through the service container <code>$container->get('hasher')</code>.
    </p>
...
$hashed = $this->hasker->make('password');
</script>
</div>
...
$raw = 'password';
$hashed = $this->hasker->make($raw);

$valid = $this->hasker->check($raw, $hashed); //true
</script>
</div>
